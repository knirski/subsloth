package subsloth.core.domain.architecture
...
/**
 * Architecture boundary tests ensuring [subsloth.core.domain] and
 * [subsloth.core.model] remain free of Android framework, network,
...
class DomainArchitectureTest {
    ...
    private val allDomainImports: List<String> by lazy {
        ...
        val domainSourceDir =
            Paths.get(baseDir, "src", "commonMain", "kotlin")
