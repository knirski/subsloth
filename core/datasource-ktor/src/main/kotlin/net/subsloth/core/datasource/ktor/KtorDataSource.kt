 ...
 *
 * Adapted from androidx.media3.datasource.ktor.KtorDataSource
 * (https://github.com/androidx/media/pull/3071)
 */
package net.subsloth.core.datasource.ktor
 ...
 * instance.
 *
 * Adapted from `androidx.media3.datasource.ktor.KtorDataSource` (AndroidX Media3 PR #3071).
 */
@UnstableApi
...
constructor(
    ...
    override fun getUri(): Uri? = response?.request?.url?.let { Uri.parse(it.toString()) } ?: dataSpec?.uri
    ...
    override fun open(dataSpec: DataSpec): Long {
                    ...
                    httpClient
                        .prepareRequest {
                            ...
                            headers {
                                ...
                                userAgent?.let { set(HttpHeaders.UserAgent, userAgent) }
        ...
        if (responseCode !in 200..299) {
            if (responseCode == 416) {
                val contentRange = httpResponse.headers[HttpHeaders.ContentRange]
            ...
            val errorResponseBody: ByteArray =
                try {
                    runBlocking {
                        ...
                        val buffer = ByteArray(ERROR_BUFFER_SIZE)
        ...
        if (contentTypePredicate != null && !contentTypePredicate(contentType)) {
            closeConnectionQuietly()
        ...
        if (dataSpec.length != C.LENGTH_UNSET.toLong()) {
            ...
            val contentLength =
                HttpUtil.getContentLength(
                    httpResponse.headers[HttpHeaders.ContentLength],
                    httpResponse.headers[HttpHeaders.ContentRange],
                )
            bytesToRead =
    ...
    companion object {
        ...
        private const val ERROR_BUFFER_SIZE = 8192
