...
## Purpose
Define the Kodi-compatible Media API contract, fixture hygiene, and offline/live contract verification boundaries for the native app.
## Requirements
...
The browser capture pipeline that produces these fixtures is defined in the `media-capture-mock-fixtures` spec.
